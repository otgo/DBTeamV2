...
return {
	["es"] = {
		translation = {
			version = "3.0",
			versionExtended = "Versión de traducción 3.0",
			lang_credits = "Traducido por @comunidadtelebots"
		},
		...
		welcome = {
			on = "Bienvenida activada.",
			on = "Bienvenida desactivada.",
			default_lang = "La bienvenida actual es la default.",
			new = "La nueva bienvenida asignada es",
			default = "Bienvenido/s %s al chat!",
		},
		...
		promote = {
			alreadyAdmin = "Este usuario ya es *admin.*: %s",
		...
		moderation = {
			...
			delXMsg = "`>` Al usuario %s *se le ha eliminado* `%i mensajes`."
		},
